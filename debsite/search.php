...
<!-- Navigation -->
    ...
    <div class="container text-center">
      <h1> <i class="fa fa-hand-peace-o" aria-hidden="true"></i> Search Results <i class="fa fa-search" aria-hidden="true"></i></h1>
    </div>
  </header>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-10 mx-auto">
               <h2 style="text-align:center" class="display-4">You Searched For : <?php echo get_search_query(); ?></h2>
...
if ( has_post_thumbnail() ) {
    the_post_thumbnail_url("post_thumbnail"); 
                        ...
                        <a role="button"  href="<?php the_permalink() ?>" class="btn btn-primary" style="float:right;margin-right:20px">Read more</a>
                     </div>
					  <hr>
                  </div>
               ...
               <?php }}else{
    echo "<br><br><h3 style='text-align:center'>No results!</h3>";
} ?>
